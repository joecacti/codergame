...
const { click: sClick, correct: sCorrect, wrong: sWrong, badge: sBadge, splash: sSplash, muted, toggleMute, voiceMightyPirate, voiceShark, voiceGary, voiceKilledUs } = useSound()
